...
def load_embeddings():
    ...
    """
    with open('emdedding_rec_sys.data', 'rb') as f:
        item_embeddings = p.load(f)
...
st.title('WOW. I WORKED MASTER!!!!! RECOMMENDER ME > < :smile:')
...
product = st.text_input('SEARCH_PRODUCT_MASTER...', '')
...
st.sidebar.header('YOU NEED THIS, BRO!!!!!: ')
#Ищем рекомендации
