...
Competition: Recommender system, SkillFactory
...
В командной работе были опробованы сновные библиотеки для построения рекомендательных систем - surprise, lightFM, LightGBM, stotlight, fast AI colab.

В реализации, я остановил свой выбор на коллаборативной фильтрации с использованием нейронной сети.
